...
$emailCheck = $conn->prepare("SELECT id FROM worker WHERE email = ?");
...
$phoneCheck = $conn->prepare("SELECT id FROM worker WHERE phone = ?");
...
if ($phoneCheck->get_result()->num_rows > 0) {
    ...
    $checkQuery = "SELECT id FROM worker WHERE email = ? OR phone = ?";
    ...
    $query = "INSERT INTO worker (first_name, last_name, gender, email, password, phone) VALUES (?, ?, ?, ?, ?, ?)";
...
<body>
    <div class="container">
        ...
        <div class="form-section">
            ...
            <form method="POST" action="register_worker.php" onsubmit="return validateForm()">
